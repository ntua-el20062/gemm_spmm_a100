...
// Fixed-point emulation APIs are not available in this CUDA environment.
// Stub it out so the project builds.
static inline size_t getFixedPointWorkspaceSizeInBytes(
    int /*m*/, int /*n*/, int /*k*/, int /*batchCount*/, bool /*isComplex*/,
    int /*mantissaControl*/, int /*maxMantissaBitCount*/)
{
    return 0;
}
