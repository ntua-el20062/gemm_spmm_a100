...
#nsys profile --trace=cuda,osrt --cuda-memory-usage=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true -o um_profile_managed_C_10k_mem_advise ./cublas_gemm_example_managed_C_mem_advise 10000 10000 10000 25 > results_%_managed_C_mem_advise_10k.txt;
#python3 plot_mem_managed_C_mem_advise.py;

nsys profile --trace=cuda,osrt --cuda-memory-usage=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true -o um_profile_managed_A_10k_mem_advise ./cublas_gemm_example_managed_A_mem_advise 10000 10000 10000 25 > results_%_managed_A_mem_advise_10k.txt;
python3 plot_mem_managed_A_mem_advise.py;

nsys profile --trace=cuda,osrt --cuda-memory-usage=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true -o um_profile_managed_A_10k_mem_advise_readmostly ./cublas_gemm_example_managed_A_mem_advise_readmostly 10000 10000 10000 25 > results_%_managed_A_mem_advise_10k_read_mostly.txt;
