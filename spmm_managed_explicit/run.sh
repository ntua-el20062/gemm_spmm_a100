...
#nsys profile --trace=cuda,osrt --cuda-memory-usage=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true -o um_profile_managed_A ./spmm_managed_A ../../suitesparse_mats/ldoor/ldoor.mtx 128 > results_%_managed_A_ldoor.txt;
#python3 plot_mem_managed_A.py;

#nsys profile --trace=cuda,osrt --cuda-memory-usage=true --cuda-um-gpu-page-faults=true --cuda-um-cpu-page-faults=true -o um_profile_managed_C ./spmm_managed_C ../../suitesparse_mats/ldoor/ldoor.mtx 128 > results_%_managed_C_ldoor.txt;
